...
export default function Footer() {
  ...
  return (
    <footer className="lg:flex border-t border-red-500 fixed inset-x-0 bottom-0 bg-black items-center justify-between 2xl:px-16 lg:px-10 py-5 px-5">
      <div className="h-full flex items-center gap-8 text-base text-[#A0A8B1] 2xl:text-base">
        <Link
          ...
          className={`h-full flex items-center justify-center hover:text-[#4070a1] ${
            currentRoute === "https://www.tensor.trade/trade/the_prem"
