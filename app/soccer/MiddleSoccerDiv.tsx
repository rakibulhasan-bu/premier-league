    ...
    return (
        <div className='w-full lg:w-[56%] my-6 2xl:my-8'>
            ...
            <div className='relative w-full h-[20dvh] lg:h-[32dvh]'>
                ...
                {/* upper div's  */}
                <div className='absolute left-0 top-0 w-full h-full z-10 bg-transparent px-[8%] py-[4%] 2xl:py-8'>
                    {/* teams details div  */}
                    <div className='flex items-center justify-between'>
                        <div className='2xl:space-y-2'>
                            <p className="text-2xl 2xl:text-4xl font-semibold uppercase">Liverpool</p>
                            <p className="pl-8 2xl:pl-12">VS</p>
                            <p className="text-2xl 2xl:text-4xl font-semibold uppercase">Everton</p>
                        </div>
